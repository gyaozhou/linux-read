...
// zhou: collect guest OS memory usage.
...
// zhou: README, handle request from hypervisor to collect memory usage???
...
// zhou: README, handle request from hypervisor to change memory size.
